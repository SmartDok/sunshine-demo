<template>
  <div>
    ...
    <p class="help">
      The <b>s-inspector</b> components content is wrapped in a <b>form</b> element. Additional
      attributes and event listeners are passed to this element. <br>
      Most of the time, users would want to handle the <b>submit</b> event, as in the example below.
    </p>
