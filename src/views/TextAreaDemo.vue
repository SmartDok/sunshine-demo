<template>
  <div>
    ...
    <p class="help">
     For more examples: <router-link to="/textarea-demo">Textarea demo page</router-link>
    </p>
    ...
    <props-list>
      ...
      <props-item name="readonly" type="Boolean">
       Sets the textarea to a read only state.
      </props-item>
    </props-list>
